...
public final class EndpointConfig {
    ...
    /** Authentication type: {@code "apikey"} or {@code "oauth2"}. */
    private final String authType;

    /**
     * Authentication value:
     * <ul>
     *   <li>For {@code apikey}: the raw API key sent as {@code X-API-Key} header.</li>
    ...
    public String getQueryScript() { return queryScript; }
